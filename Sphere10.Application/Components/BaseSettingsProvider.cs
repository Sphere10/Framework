...
namespace Sphere10.Application {
	...
	public class BaseSettingsProvider : XMLFileSettingsProvider {

		public BaseSettingsProvider(IProductInformationServices productInformationServices, Environment.SpecialFolder specialFolder, string fileName) 
			: base (
				string.Format(
					"{1}{0}{2}{0}{3}{0}{4}",
