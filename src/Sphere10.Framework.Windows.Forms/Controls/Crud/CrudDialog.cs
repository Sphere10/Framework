...
namespace Sphere10.Framework.Windows.Forms {
	public partial class CrudDialog : Form {
		...
		public static void Show<TEntity>(string title, IEnumerable<ICrudGridColumn> gridBindings, CrudCapabilities capabilities, ICrudDataSource<TEntity> dataSource) {
