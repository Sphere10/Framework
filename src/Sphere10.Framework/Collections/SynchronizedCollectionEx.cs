...
namespace Sphere10.Framework {
	...
	public class SynchronizedCollectionEx<T> : ICollection<T>, IThreadSafeObject {
		private readonly ReaderWriterLockSlim _threadLock;
		private readonly ICollection<T> _internalCollection;
	
		public SynchronizedCollectionEx() : this(new List<T>()) {
		}

		public SynchronizedCollectionEx(ICollection<T> internalList) {
