...
namespace Sphere10.Framework {
    public class ProducerConsumerQueue<T> : Disposable {
        ...
        private readonly CallQueue _producerQueue;
        private readonly CallQueue _consumerQueue;
        ...
        public ProducerConsumerQueue(Func<T, long> sizeEstimator, long maxCapacity, long maxPutSize) {
            if (maxPutSize < 1) throw new ArgumentOutOfRangeException("maxPutSize", maxPutSize, "Must be greater than 1 and less than maxCapacity");
            if (maxPutSize > maxCapacity) throw new ArgumentOutOfRangeException("maxPutSize", maxPutSize, "Must be greater than 1 and less than maxCapacity");
            ...
            _producerQueue = new CallQueue(_threadLock);
            _consumerQueue = new CallQueue(_threadLock);
        }
        ...
        public virtual long MaxPutSize {
            get {
                return _maxPutSize;
            }
        }
        ...
        public virtual T[] TakeMany(int maxItems) {
            if (maxItems < 0) throw new ArgumentOutOfRangeException("maxSize");
