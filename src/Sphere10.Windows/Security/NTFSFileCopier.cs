...
namespace Sphere10.Windows.Security {
    ...
    public class NTFSFileCopier  {
        ...
        public void CopyFileOwner(string sourceFile, string destFile) {
            ...
            try {
                FileSecurity sourceSecurity = File.GetAccessControl(sourceFile);
                FileSecurity destSecurity = File.GetAccessControl(destFile);
                ...
                File.SetAccessControl(destFile, destSecurity);
        ...
        public void CopyDirectoryOwnership(string sourceDir, string destDir) {
            ...
            try {
                ...
                DirectorySecurity sourceSecurity = Directory.GetAccessControl(sourceDir);
                DirectorySecurity destSecurity = Directory.GetAccessControl(destDir);
                ...
                Directory.SetAccessControl(destDir, destSecurity);
        ...
        public void CopyDirectorySecurity(string sourceDir, string destDir) {
            ...
            try {
                Directory.SetAccessControl(
                    destDir,
                    TranslateDirectoryACL(
                        Directory.GetAccessControl(sourceDir)
                    )
                );
            } catch (Exception e) {
                ActionObserver.NotifyActionFailed("Copy", "Directory Security", sourceDir, destDir, e.ToDisplayString());
        ...
        public void CopyFileSecurity(string sourceFile, string destFile) {
            ...
            try {
                File.SetAccessControl(
                    destFile,
                        TranslateFileACL(
                            File.GetAccessControl(sourceFile)
                        )
                );
            } catch (Exception e) {
        ...
        public void GiveLocalAdministratorsOwnershipOfDirectory(string directory) {
            ...
            try {
                ...
                try {
                    DirectorySecurity security = Directory.GetAccessControl(directory, AccessControlSections.Owner);
                    ...
                    Directory.SetAccessControl(directory, newSecurity);
                }
        ...
        public void GiveLocalAdministratorsOwnershipOfFile(string file) {
            ...
            try {
                ...
                try {
                    File.SetAttributes(file, FileAttributes.Normal);
                    FileSecurity security = File.GetAccessControl(file, AccessControlSections.Owner);
                    ...
                    File.SetAccessControl(file, newSecurity);
                }
            } catch (Exception e) {
