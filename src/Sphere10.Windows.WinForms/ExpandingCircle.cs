...
namespace Sphere10.Common {
	public class ExpandingCircle : Form {
		...
		// Static Activators
		public static void ShowExpandingCircle(int centreX, int centreY, Color color, int thickness, int maxRadius) {
			var frm = new ExpandingCircle(centreX, centreY, DefaultCircleStartRadius, thickness, DefaultExpansionSpeed, color, maxRadius);
