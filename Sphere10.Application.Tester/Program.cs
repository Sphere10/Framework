...
namespace Sphere10.Application.Tester {
    ...
    static class Program
    {
        ...
        static void Main() {
            ...
            System.Windows.Forms.Application.ThreadException += (s, e) => Tools.Lambda.ActionIgnoringExceptions(() => ExceptionDialog.Show("Error", e.Exception)).Invoke();
            ...
            ApplicationLifecycle.Instance.StartWinFormsApplication<Form1>();
        }
    }
}
