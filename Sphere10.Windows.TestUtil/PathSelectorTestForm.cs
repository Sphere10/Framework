...
namespace Sphere10.Windows.TestUtil {
    public partial class PathSelectorTestForm : Form {
        ...
        private void pathSelectorControl1_PathChanged(object sender, EventArgs e) {
            try {
        ...
        private void pathSelectorControl2_PathChanged(object sender, EventArgs e) {
            try {
        ...
        private void pathSelectorControl3_PathChanged(object sender, EventArgs e) {
            try {
