...
namespace Sphere10.Application.WinForms
{
    partial class BlockMainForm
    {
        ...
        private void InitializeComponent() {
			...
			this._applicationBar = new Sphere10.Application.WinForms.ApplicationBar();
			...
			this._applicationBar.AutoDetectChildStateChanges = false;
			this._applicationBar.ButtonHeight = 32;
			this._applicationBar.Name = "_applicationBar";
			this._applicationBar.SelectedItem = null;
			this._applicationBar.ButtonPressed += new Sphere10.Application.WinForms.ButtonPressedHandler(this._applicationBar_ButtonPressed);
			// 
			// _splitter
			// 
        ...
        private Sphere10.Application.WinForms.ApplicationBar _applicationBar;
