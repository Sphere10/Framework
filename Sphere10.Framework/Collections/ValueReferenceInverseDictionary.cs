...
namespace Sphere10.Framework.Collections {
	public class ValueReferenceInverseDictionary<TKey, TValue> : ILookup<TValue, TKey> where TValue : class {
		...
		public int Count { get { return _valueReferenceToKeyLookup.Count; } }

		public IEnumerable<TKey> this[TValue key] {
			get {
				return _valueReferenceToKeyLookup[Reference.For(key)];
			}
		}
