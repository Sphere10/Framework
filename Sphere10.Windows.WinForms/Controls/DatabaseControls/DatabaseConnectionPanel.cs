...
namespace Sphere10.Windows.WinForms {
	...
	public partial class DatabaseConnectionPanel : ConnectionPanelBase, IDatabaseConnectionProvider {
		private const string MSSQLConnectionPanelTypeName = "Sphere10.Windows.WinForms.MSSQLConnectionPanel, Sphere10.Windows.WinForms";
		...
		protected virtual void SelectDefaultPanel() {
			ChangeConnectionPanel(new MSSQLConnectionPanel());
		}
