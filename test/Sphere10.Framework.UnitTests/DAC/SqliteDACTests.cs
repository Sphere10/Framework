...
namespace Sphere10.Framework.UnitTests {
    ...
    public class SqliteDACTests {
        ...
        public void CreateDatabase() {
            ...
            File.WriteAllBytes(DBFile, Sphere10.Framework.UnitTests.Properties.Resource.TestSqliteDatabase);
        }
	...
	Data1 UNIQUEIDENTIFIER NOT NULL
            ...
            try {
                SystemLog.RegisterLogger(new ConsoleLogger());
                var guid = Guid.NewGuid();
                SystemLog.Debug("Generated Guid: {0}", guid);
	...
	Data1 UNIQUEIDENTIFIER NOT NULL
            ...
            try {
                ...
                SystemLog.Debug("Empty Guid: {0}", emptyGuid);
